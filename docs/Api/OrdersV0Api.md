...
# **getOrder**
> \AmazonSP\Model\GetOrderResponse getOrder($order_id)
...
[**\AmazonSP\Model\GetOrderResponse**](../Model/GetOrderResponse.md)
...
# **getOrderAddress**
> \AmazonSP\Model\GetOrderAddressResponse getOrderAddress($order_id)
...
[**\AmazonSP\Model\GetOrderAddressResponse**](../Model/GetOrderAddressResponse.md)
...
# **getOrderBuyerInfo**
> \AmazonSP\Model\GetOrderBuyerInfoResponse getOrderBuyerInfo($order_id)
...
[**\AmazonSP\Model\GetOrderBuyerInfoResponse**](../Model/GetOrderBuyerInfoResponse.md)
...
# **getOrderItems**
> \AmazonSP\Model\GetOrderItemsResponse getOrderItems($order_id, $next_token)
...
[**\AmazonSP\Model\GetOrderItemsResponse**](../Model/GetOrderItemsResponse.md)
...
> \AmazonSP\Model\GetOrderItemsBuyerInfoResponse getOrderItemsBuyerInfo($order_id, $next_token)
...
[**\AmazonSP\Model\GetOrderItemsBuyerInfoResponse**](../Model/GetOrderItemsBuyerInfoResponse.md)
...
# **getOrders**
> \AmazonSP\Model\GetOrdersResponse getOrders($marketplace_ids, $created_after, $created_before, $last_updated_after, $last_updated_before, $order_statuses, $fulfillment_channels, $payment_methods, $buyer_email, $seller_order_id, $max_results_per_page, $easy_ship_shipment_statuses, $next_token, $amazon_order_ids)
...
[**\AmazonSP\Model\GetOrdersResponse**](../Model/GetOrdersResponse.md)
