...
'product_info' => '\AmazonSP\Model\ProductInfoDetail',
'points_granted' => '\AmazonSP\Model\PointsGrantedDetail',
'item_price' => '\AmazonSP\Model\Money',
'shipping_price' => '\AmazonSP\Model\Money',
'item_tax' => '\AmazonSP\Model\Money',
'shipping_tax' => '\AmazonSP\Model\Money',
'shipping_discount' => '\AmazonSP\Model\Money',
'shipping_discount_tax' => '\AmazonSP\Model\Money',
'promotion_discount' => '\AmazonSP\Model\Money',
'promotion_discount_tax' => '\AmazonSP\Model\Money',
'promotion_ids' => '\AmazonSP\Model\PromotionIdList',
'cod_fee' => '\AmazonSP\Model\Money',
'cod_fee_discount' => '\AmazonSP\Model\Money',
'is_gift' => 'bool',
...
'tax_collection' => '\AmazonSP\Model\TaxCollection',
...
self::DEEMED_RESELLER_CATEGORY_UOSS,        ];
     ...
     * Gets product_info
     *
     * @return \AmazonSP\Model\ProductInfoDetail
     */
     ...
     * Sets product_info
     *
     * @param \AmazonSP\Model\ProductInfoDetail $product_info product_info
     *
     * @return $this
     */
     ...
     * Gets points_granted
     *
     * @return \AmazonSP\Model\PointsGrantedDetail
     */
     ...
     * Sets points_granted
     *
     * @param \AmazonSP\Model\PointsGrantedDetail $points_granted points_granted
     *
     * @return $this
     */
     ...
     * Sets item_price
     *
     * @param \AmazonSP\Model\Money $item_price item_price
     *
     * @return $this
     */
     ...
     * Sets shipping_price
     *
     * @param \AmazonSP\Model\Money $shipping_price shipping_price
     *
     * @return $this
     */
     ...
     * Sets item_tax
     *
     * @param \AmazonSP\Model\Money $item_tax item_tax
     *
     * @return $this
     */
     ...
     * Sets shipping_tax
     *
     * @param \AmazonSP\Model\Money $shipping_tax shipping_tax
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Model\Money $shipping_discount shipping_discount
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Model\Money $shipping_discount_tax shipping_discount_tax
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Model\Money $promotion_discount promotion_discount
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Model\Money $promotion_discount_tax promotion_discount_tax
     *
     * @return $this
     */
     ...
     * Gets promotion_ids
     *
     * @return \AmazonSP\Model\PromotionIdList
     */
     ...
     * Sets promotion_ids
     *
     * @param \AmazonSP\Model\PromotionIdList $promotion_ids promotion_ids
     *
     * @return $this
     */
     ...
     * Sets cod_fee
     *
     * @param \AmazonSP\Model\Money $cod_fee cod_fee
     *
     * @return $this
     */
     ...
     *
     * @param \AmazonSP\Model\Money $cod_fee_discount cod_fee_discount
     *
     * @return $this
     */
     ...
     * Gets tax_collection
     *
     * @return \AmazonSP\Model\TaxCollection
     */
     ...
     * Sets tax_collection
     *
     * @param \AmazonSP\Model\TaxCollection $tax_collection tax_collection
     *
     * @return $this
     */
